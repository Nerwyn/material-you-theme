...
<!-- READ THIS FIRST:
- Are you in the right repository? Is this a request for theme tokens or a new companion module feature? This theme only can define new values for Home Assistant theme CSS custom properties. The companion module handles all color theme generation and advanced style modification.
